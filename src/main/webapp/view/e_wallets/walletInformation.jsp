...
<%--                <a id="editButton">sửa tài khoản</a>--%>
<%--                <a href="<%=request.getContextPath()%>/deleteWallet" onclick="dodelete(${idWallet})">xóa tài khoản</a>--%>
<%--            </div>--%>
<%--        </form>--%>
<%--    </div>--%>
...
<%--            </c:if>--%>
<%--&lt;%&ndash;    <div id="editSection" class="section">&ndash;%&gt;--%>
...
<%--                <ion-icon name="calendar-outline"></ion-icon>--%>
<%--                <input type="text" value="${expirationDate}" id="date" name="date" onkeypress="return isNumeric(event)">--%>
